...
class Config(object):
    ...
    #TARGET_VOCAB_SIZE = 26+10+3 +4 # 0: PADDING, 1: GO, 2: EOS, >2: 0-9, a-z
    TARGET_VOCAB_SIZE = 26+10+3 +2 # 0: PADDING, 1: GO, 2: EOS, >2: 0-9, a-z
    #TARGET_VOCAB_SIZE = 26+10+3 +18 # 0: PADDING, 1: GO, 2: EOS, >2: 0-9, a-z	
    #TARGET_VOCAB_SIZE = 26+10+3 +4+3 # 0: PADDING, 1: GO, 2: EOS, >2: 0-9, a-z		
